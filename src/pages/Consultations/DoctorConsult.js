...
const DoctorConsult = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.title}>Speak to a Doctor</Text>
      ...
      <View style={styles.consultationTypes}>
        <TouchableOpacity style={styles.optionCard}>
          ...
          <Text style={styles.optionDescription}>
            Face-to-face video call with a licensed physician
          </Text>
        ...
        <TouchableOpacity style={styles.optionCard}>
          ...
          <Text style={styles.optionDescription}>
            Text-based consultation with a doctor
          </Text>
          <Text style={styles.duration}>Unlimited messages for 24 hours</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
...
// Using the same styles as PharmacistConsult
